...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   [_BASE] = LAYOUT( \
     ...
     KC_TAB         , KC_Q          , KC_W          , KC_E          , KC_R          , KC_T          , MO(_NAV)      ,                                 MO(_RGB)      , KC_Y          , KC_U          , KC_I          , KC_O          , KC_P          , KC_LBRC       ,\
     KC_LSFT        , KC_A          , KC_S          , KC_D          , KC_F          , KC_G          , MO(_FN)       ,                                 MO(_SYM)      , KC_H          , KC_J          , KC_K          , KC_L          , KC_SCLN       , KC_QUOT       ,\
     KC_LCTL        , KC_Z          , KC_X          , KC_C          , KC_V          , KC_B          , KC_BSPC       , MO(_SYM)      , MO(_NAV)      , KC_ENT        , KC_N          , KC_M          , KC_COMM       , KC_DOT        , KC_SLSH       , KC_RSFT      ,\
                                                      TG(_GAME)     , KC_LALT       , KC_SPC        , KC_BSPC       , KC_LGUI	    , MO(_NAV)      , KC_ENT        , KC_SPC        , KC_RALT       , TG(_GAME)\
  ),
   [_SYM] = LAYOUT( \
